...
namespace MealWheel.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [StringLength(250, ErrorMessage = "The first name must be not more than 250")]
            public string FirstName { get; set; }

            [Required]
            [Display(Name = "lastname")]
            [StringLength(250, ErrorMessage = "The last name must be not more than 250")]
            public string LastName { get; set; }

            [Required]
            [Display(Name = "Address")]
            [StringLength(250, ErrorMessage = "The Address must be not more than 250")]
            public string Address { get; set; }

            [Required]
            [Display(Name = "MobieNumber")]
            [StringLength(10, ErrorMessage = "The Mobile number should be only 10 charecters", MinimumLength = 10)]
